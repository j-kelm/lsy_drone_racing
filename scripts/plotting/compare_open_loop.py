...
if __name__ == "__main__":
    ...
    sample_index = rng.choice(len(local_obs), size=n_samples, replace=False)[0]
    ...
    print('Sampled diffusion model UwU')

    fig, axs = plt.subplots(local_actions.shape[1], sharex=True)
