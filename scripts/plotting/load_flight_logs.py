"""Load logs from a single experiment run using MPC or diffusion policy.
"""

file_path = "output/logs/mm/diff_a=2_s=100_i=5/diff_01.npz"

from lsy_drone_racing.control.mpc.mpc_utils import outputs_for_actions
from lsy_drone_racing.utils.plotting import *

flight_data = np.load(file_path, allow_pickle=True)
